...
parser.add_argument('--batch_size', type=int,default='',help="Batch size to use per GPU")
...
parser.add_argument("--num_gpus",type=int,default='', help = "Number of GPUs to use for training")
